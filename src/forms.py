...
from wtforms import StringField, SubmitedField, PasswordField, TextAreaField, DateField, TimeField,IntegerField, BooleanField
...
class Ad_Event(Flaskform):
  ...
  max_attendess = IntegerField("Maxium number of attendees", validators=[DataRequired])
